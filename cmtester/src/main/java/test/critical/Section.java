        ...
        synchronized (this) {
            ...
            if (threadNum == 0) {
                ...
                try {
                    ...
                    fileWriter = new FileWriter("F:\\CMTester\\output\\Critical.txt",true);
                    fileWriter.write("follow-up output:"+"\n");
                ...
                while (t.turn != 0) {
                    ...
                    System.out.println("0's turn do not allow 1");
                    System.setOut(oldPrintStream1);
                    FileWriter fileWriter1 = null;
                    try {

                        fileWriter1 = new FileWriter("F:\\CMTester\\output\\Critical.txt",true);
                ...
                try {
                    ...
                    fileWriter2 = new FileWriter("F:\\CMTester\\output\\Critical.txt",true);
                ...
                if (threadNum == 1) {
                    ...
                    while (t.turn != 1) {
                        ...
                        ByteArrayOutputStream bos1 = new ByteArrayOutputStream();
                        System.setOut(new PrintStream(bos1)); //设置新的out
                        System.out.println("1's turn do not allow 0");
                        System.setOut(oldPrintStream1);
                        FileWriter fileWriter1 = null;
                        try {
