 ...
 * @date 2020/9/8
 */
public class SharedVariableTaModel extends AbstractTableModel{
    private static final long serialVersionUID=106L;
    String[] columnHeader = new String[]{"SharedVariable ID","SharedVariable Name"};
    Object[][] data;
    public SharedVariableTaModel(Vector value){
