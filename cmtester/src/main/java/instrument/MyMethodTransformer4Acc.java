...
public class MyMethodTransformer4Acc extends AdviceAdapter implements Opcodes {
    ...
    protected MyMethodTransformer4Acc(MethodVisitor mv, int access, String name, String desc) {
    ...
    private void instrumentField(boolean isBefore, boolean isRead, String fieldOwner, String fieldName, String fieldDesc){
        ...
        if (isBefore) {
            mv.visitMethodInsn(Opcodes.INVOKESTATIC,
                    Instrumentor.EVENT_RECIEVER2,
                    "beforeFieldRead",
                    BOOL_3STRINGS_INT_VOID);
        } else {
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, Instrumentor.EVENT_RECIEVER2, "beforeFieldWrite", BOOL_3STRINGS_INT_VOID,false);
        }
    }
