...
public class MyMethodTransformer4Air extends AdviceAdapter implements Opcodes {
    ...
    protected MyMethodTransformer4Air(MethodVisitor mv, int access, String name, String desc) {
    ...
    private void instrumentField(boolean isBefore, boolean isRead, String fieldOwner, String fieldName, String fieldDesc){
        ...
        if (isBefore) {
            mv.visitMethodInsn(Opcodes.INVOKESTATIC,
                    Instrumentor.EVENT_RECIEVER3,
                    "beforeFieldRead",
                    BOOL_3STRINGS_INT_VOID);
        } else {
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, Instrumentor.EVENT_RECIEVER3, "beforeFieldWrite", BOOL_3STRINGS_INT_VOID,false);
        }
    }
